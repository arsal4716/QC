        ...
        <div className="card-body">
          {users.length === 0 ? (
            <EmptyState 
              ...
              message={searchTerm ? "Try adjusting your search terms" : "Create your first user to get started"}
            />
          ) : (
            <>
                ...
                <div className="d-flex justify-content-center mt-4">
                  <nav>
                    <ul className="pagination">
                      ...
                      <li className={`page-item ${pagination.page === pageInfo.totalPages ? 'disabled' : ''}`}>
                        <button
                          className="page-link"
                          onClick={() => handlePageChange(pagination.page + 1)}
                          disabled={pagination.page === pageInfo.totalPages || isLoadingState}
                        >
                          Next
                        </button>
                      </li>
